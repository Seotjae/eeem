                   ...
                   <div class="col-md-12">
                       <nav>
                           <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                               ...
                               <a class="nav-item nav-link active" id="nav-make-tab" data-toggle="tab" href="myPageMake" role="tab" aria-controls="nav-make" aria-selected="true">개설한 모임</a>
                   	   ...
                   	   <div class="tab-content" id="nav-tabContent">
							<div class="tab-pane fade show active" id="nav-make" role="tabpanel" aria-labelledby="nav-make-tab">

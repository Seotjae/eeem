...
<!--===============================================================================================-->
	<style>
		...
		#tab1:hover,#tab2:hover,#tab3:hover,#tab4:hover,#tab6:hover{
			background-color: #7AD7BE;
			color : yellow;
		}
